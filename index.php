      ...
      <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0 backgrnd grid-cols-8">
        ...
        <?php endforeach;?>
          ...
          <form method="post">
              ...
              <br>
              <button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href="userSignup.php">Sign-Up</a></button>
          </form>
